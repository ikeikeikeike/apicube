...
func testDTBProductToManyProductDTBCustomerFavoriteProducts(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	check, err := a.ProductDTBCustomerFavoriteProducts().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	if err = a.L.LoadProductDTBCustomerFavoriteProducts(ctx, tx, false, (*[]*DTBProduct)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.ProductDTBCustomerFavoriteProducts); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.ProductDTBCustomerFavoriteProducts = nil
	if err = a.L.LoadProductDTBCustomerFavoriteProducts(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.ProductDTBCustomerFavoriteProducts); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testDTBProductToManyProductDTBOrderItems(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	check, err := a.ProductDTBOrderItems().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := DTBProductSlice{&a}
	if err = a.L.LoadProductDTBOrderItems(ctx, tx, false, (*[]*DTBProduct)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.ProductDTBOrderItems); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.ProductDTBOrderItems = nil
	if err = a.L.LoadProductDTBOrderItems(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.ProductDTBOrderItems); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testDTBProductToManyProductDTBTaxRules(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	check, err := a.ProductDTBTaxRules().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := DTBProductSlice{&a}
	if err = a.L.LoadProductDTBTaxRules(ctx, tx, false, (*[]*DTBProduct)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.ProductDTBTaxRules); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.ProductDTBTaxRules = nil
	if err = a.L.LoadProductDTBTaxRules(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.ProductDTBTaxRules); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testDTBProductToManyAddOpProductDTBCustomerFavoriteProducts(t *testing.T) {
	var err error
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddProductDTBCustomerFavoriteProducts(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.R.ProductDTBCustomerFavoriteProducts[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.ProductDTBCustomerFavoriteProducts[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.ProductDTBCustomerFavoriteProducts().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
...
func testDTBProductToManySetOpProductDTBCustomerFavoriteProducts(t *testing.T) {
	var err error
	...
	err = a.SetProductDTBCustomerFavoriteProducts(ctx, tx, false, &b, &c)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.SetProductDTBCustomerFavoriteProducts(ctx, tx, true, &d, &e)
	if err != nil {
		t.Fatal(err)
	}
	...
	if a.R.ProductDTBCustomerFavoriteProducts[0] != &d {
		t.Error("relationship struct slice not set to correct value")
	}
	if a.R.ProductDTBCustomerFavoriteProducts[1] != &e {
		t.Error("relationship struct slice not set to correct value")
	}
}

func testDTBProductToManyRemoveOpProductDTBCustomerFavoriteProducts(t *testing.T) {
	var err error
	...
	err = a.AddProductDTBCustomerFavoriteProducts(ctx, tx, true, foreigners...)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.RemoveProductDTBCustomerFavoriteProducts(ctx, tx, foreigners[:2]...)
	if err != nil {
		t.Fatal(err)
	}
	...
	if len(a.R.ProductDTBCustomerFavoriteProducts) != 2 {
		t.Error("should have preserved two relationships")
	}

	// Removal doesn't do a stable deletion for performance so we have to flip the order
	if a.R.ProductDTBCustomerFavoriteProducts[1] != &d {
		t.Error("relationship to d should have been preserved")
	}
	if a.R.ProductDTBCustomerFavoriteProducts[0] != &e {
		t.Error("relationship to e should have been preserved")
	}
}

func testDTBProductToManyAddOpProductDTBOrderItems(t *testing.T) {
	var err error
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddProductDTBOrderItems(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.R.ProductDTBOrderItems[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.ProductDTBOrderItems[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.ProductDTBOrderItems().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testDTBProductToManySetOpProductDTBOrderItems(t *testing.T) {
	var err error
	...
	err = a.SetProductDTBOrderItems(ctx, tx, false, &b, &c)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.SetProductDTBOrderItems(ctx, tx, true, &d, &e)
	if err != nil {
		t.Fatal(err)
	}
	...
	if a.R.ProductDTBOrderItems[0] != &d {
		t.Error("relationship struct slice not set to correct value")
	}
	if a.R.ProductDTBOrderItems[1] != &e {
		t.Error("relationship struct slice not set to correct value")
	}
}

func testDTBProductToManyRemoveOpProductDTBOrderItems(t *testing.T) {
	var err error
	...
	err = a.AddProductDTBOrderItems(ctx, tx, true, foreigners...)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.RemoveProductDTBOrderItems(ctx, tx, foreigners[:2]...)
	if err != nil {
		t.Fatal(err)
	}
	...
	if len(a.R.ProductDTBOrderItems) != 2 {
		t.Error("should have preserved two relationships")
	}

	// Removal doesn't do a stable deletion for performance so we have to flip the order
	if a.R.ProductDTBOrderItems[1] != &d {
		t.Error("relationship to d should have been preserved")
	}
	if a.R.ProductDTBOrderItems[0] != &e {
		t.Error("relationship to e should have been preserved")
	}
}
...
func testDTBProductToManyAddOpProductDTBTaxRules(t *testing.T) {
	var err error
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddProductDTBTaxRules(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.R.ProductDTBTaxRules[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.ProductDTBTaxRules[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.ProductDTBTaxRules().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testDTBProductToManySetOpProductDTBTaxRules(t *testing.T) {
	var err error
	...
	err = a.SetProductDTBTaxRules(ctx, tx, false, &b, &c)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.SetProductDTBTaxRules(ctx, tx, true, &d, &e)
	if err != nil {
		t.Fatal(err)
	}
	...
	if a.R.ProductDTBTaxRules[0] != &d {
		t.Error("relationship struct slice not set to correct value")
	}
	if a.R.ProductDTBTaxRules[1] != &e {
		t.Error("relationship struct slice not set to correct value")
	}
}

func testDTBProductToManyRemoveOpProductDTBTaxRules(t *testing.T) {
	var err error
	...
	err = a.AddProductDTBTaxRules(ctx, tx, true, foreigners...)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.RemoveProductDTBTaxRules(ctx, tx, foreigners[:2]...)
	if err != nil {
		t.Fatal(err)
	}
	...
	if len(a.R.ProductDTBTaxRules) != 2 {
		t.Error("should have preserved two relationships")
	}

	// Removal doesn't do a stable deletion for performance so we have to flip the order
	if a.R.ProductDTBTaxRules[1] != &d {
		t.Error("relationship to d should have been preserved")
	}
	if a.R.ProductDTBTaxRules[0] != &e {
		t.Error("relationship to e should have been preserved")
	}
}

func testDTBProductToOneMTBProductStatusUsingProductStatus(t *testing.T) {
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()

	var local DTBProduct
	var foreign MTBProductStatus

	seed := randomize.NewSeed()
	if err := randomize.Struct(seed, &local, dtbProductDBTypes, true, dtbProductColumnsWithDefault...); err != nil {
		t.Errorf("Unable to randomize DTBProduct struct: %s", err)
	}
	if err := randomize.Struct(seed, &foreign, mtbProductStatusDBTypes, false, mtbProductStatusColumnsWithDefault...); err != nil {
	...
	queries.Assign(&local.ProductStatusID, foreign.ID)
	if err := local.Insert(ctx, tx, boil.Infer()); err != nil {
		t.Fatal(err)
	}

	check, err := local.ProductStatus().One(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := DTBProductSlice{&local}
	if err = local.L.LoadProductStatus(ctx, tx, false, (*[]*DTBProduct)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if local.R.ProductStatus == nil {
		t.Error("struct should have been eager loaded")
	}

	local.R.ProductStatus = nil
	if err = local.L.LoadProductStatus(ctx, tx, true, &local, nil); err != nil {
		t.Fatal(err)
	}
	if local.R.ProductStatus == nil {
		t.Error("struct should have been eager loaded")
...
func testDTBProductToOneDTBMemberUsingCreator(t *testing.T) {
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := DTBProductSlice{&local}
	if err = local.L.LoadCreator(ctx, tx, false, (*[]*DTBProduct)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testDTBProductToOneSetOpMTBProductStatusUsingProductStatus(t *testing.T) {
	var err error
	...
	var a DTBProduct
	var b, c MTBProductStatus

	seed := randomize.NewSeed()
	if err = randomize.Struct(seed, &a, dtbProductDBTypes, false, strmangle.SetComplement(dtbProductPrimaryKeyColumns, dtbProductColumnsWithoutDefault)...); err != nil {
		t.Fatal(err)
	}
	if err = randomize.Struct(seed, &b, mtbProductStatusDBTypes, false, strmangle.SetComplement(mtbProductStatusPrimaryKeyColumns, mtbProductStatusColumnsWithoutDefault)...); err != nil {
		t.Fatal(err)
	}
	if err = randomize.Struct(seed, &c, mtbProductStatusDBTypes, false, strmangle.SetComplement(mtbProductStatusPrimaryKeyColumns, mtbProductStatusColumnsWithoutDefault)...); err != nil {
		t.Fatal(err)
	}
	...
	for i, x := range []*MTBProductStatus{&b, &c} {
		err = a.SetProductStatus(ctx, tx, i != 0, x)
		if err != nil {
			t.Fatal(err)
		}

		if a.R.ProductStatus != x {
			t.Error("relationship struct not set to correct value")
		}

		if x.R.ProductStatusDTBProducts[0] != &a {
			t.Error("failed to append to foreign relationship struct")
		}
		if !queries.Equal(a.ProductStatusID, x.ID) {
			t.Error("foreign key was wrong value", a.ProductStatusID)
		}

		zero := reflect.Zero(reflect.TypeOf(a.ProductStatusID))
		reflect.Indirect(reflect.ValueOf(&a.ProductStatusID)).Set(zero)
		...
		if !queries.Equal(a.ProductStatusID, x.ID) {
			t.Error("foreign key was wrong value", a.ProductStatusID, x.ID)
		}
	}
}

func testDTBProductToOneRemoveOpMTBProductStatusUsingProductStatus(t *testing.T) {
	var err error
	...
	if err = a.SetProductStatus(ctx, tx, true, &b); err != nil {
		t.Fatal(err)
	}

	if err = a.RemoveProductStatus(ctx, tx, &b); err != nil {
		t.Error("failed to remove relationship")
	}

	count, err := a.ProductStatus().Count(ctx, tx)
	if err != nil {
		t.Error(err)
	}
	if count != 0 {
	...
	if a.R.ProductStatus != nil {
		t.Error("R struct entry should be nil")
	}

	if !queries.IsValuerNil(a.ProductStatusID) {
		t.Error("foreign key value should be nil")
	}

	if len(b.R.ProductStatusDTBProducts) != 0 {
		t.Error("failed to remove a from b's relationships")
	}
}

func testDTBProductToOneSetOpDTBMemberUsingCreator(t *testing.T) {
	var err error
...
func testDTBProductToOneRemoveOpDTBMemberUsingCreator(t *testing.T) {
	var err error
	...
	if len(b.R.CreatorDTBProducts) != 0 {
		t.Error("failed to remove a from b's relationships")
	}
}
