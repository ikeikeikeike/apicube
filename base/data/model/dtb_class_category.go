...
var DTBClassCategoryRels = struct {
	Creator                           string
	ClassName                         string
	ClassCategoryID1DTBProductClasses string
	ClassCategoryID2DTBProductClasses string
}{
	Creator:                           "Creator",
	ClassName:                         "ClassName",
	ClassCategoryID1DTBProductClasses: "ClassCategoryID1DTBProductClasses",
	ClassCategoryID2DTBProductClasses: "ClassCategoryID2DTBProductClasses",
}
...
type dtbClassCategoryR struct {
	...
	ClassCategoryID1DTBProductClasses DTBProductClassSlice
	ClassCategoryID2DTBProductClasses DTBProductClassSlice
}
...
func (o *DTBClassCategory) Creator(mods ...qm.QueryMod) dtbMemberQuery {
...
// ClassCategoryID1DTBProductClasses retrieves all the dtb_product_class's DTBProductClasses with an executor via class_category_id1 column.
func (o *DTBClassCategory) ClassCategoryID1DTBProductClasses(mods ...qm.QueryMod) dtbProductClassQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`dtb_product_class`.`class_category_id1`=?", o.ID),
	)
...
// ClassCategoryID2DTBProductClasses retrieves all the dtb_product_class's DTBProductClasses with an executor via class_category_id2 column.
func (o *DTBClassCategory) ClassCategoryID2DTBProductClasses(mods ...qm.QueryMod) dtbProductClassQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("`dtb_product_class`.`class_category_id2`=?", o.ID),
	)
...
func (dtbClassCategoryL) LoadCreator(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDTBClassCategory interface{}, mods queries.Applicator) error {
	...
	if singular {
		...
		foreign.R.CreatorDTBClassCategories = append(foreign.R.CreatorDTBClassCategories, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.CreatorID, foreign.ID) {
				...
				foreign.R.CreatorDTBClassCategories = append(foreign.R.CreatorDTBClassCategories, local)
				break
			}
		}
	}
...
// LoadClassCategoryID1DTBProductClasses allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (dtbClassCategoryL) LoadClassCategoryID1DTBProductClasses(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDTBClassCategory interface{}, mods queries.Applicator) error {
	var slice []*DTBClassCategory
	var object *DTBClassCategory
	...
	query := NewQuery(qm.From(`dtb_product_class`), qm.WhereIn(`class_category_id1 in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.ClassCategoryID1DTBProductClasses = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &dtbProductClassR{}
			}
			foreign.R.ClassCategoryID1 = object
		}
		return nil
	}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if queries.Equal(local.ID, foreign.ClassCategoryID1) {
				local.R.ClassCategoryID1DTBProductClasses = append(local.R.ClassCategoryID1DTBProductClasses, foreign)
				if foreign.R == nil {
					foreign.R = &dtbProductClassR{}
				}
				foreign.R.ClassCategoryID1 = local
				break
			}
		}
	}
...
// LoadClassCategoryID2DTBProductClasses allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (dtbClassCategoryL) LoadClassCategoryID2DTBProductClasses(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDTBClassCategory interface{}, mods queries.Applicator) error {
	var slice []*DTBClassCategory
	var object *DTBClassCategory
	...
	query := NewQuery(qm.From(`dtb_product_class`), qm.WhereIn(`class_category_id2 in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.ClassCategoryID2DTBProductClasses = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &dtbProductClassR{}
			}
			foreign.R.ClassCategoryID2 = object
		}
		return nil
	}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if queries.Equal(local.ID, foreign.ClassCategoryID2) {
				local.R.ClassCategoryID2DTBProductClasses = append(local.R.ClassCategoryID2DTBProductClasses, foreign)
				if foreign.R == nil {
					foreign.R = &dtbProductClassR{}
				}
				foreign.R.ClassCategoryID2 = local
				break
			}
		}
	}
...
// SetCreator of the dtbClassCategory to the related item.
// Sets o.R.Creator to related.
// Adds o to related.R.CreatorDTBClassCategories.
func (o *DTBClassCategory) SetCreator(ctx context.Context, exec boil.ContextExecutor, insert bool, related *DTBMember) error {
	var err error
	if insert {
	...
	if related.R == nil {
		related.R = &dtbMemberR{
			CreatorDTBClassCategories: DTBClassCategorySlice{o},
		}
	} else {
		related.R.CreatorDTBClassCategories = append(related.R.CreatorDTBClassCategories, o)
	}
...
func (o *DTBClassCategory) RemoveCreator(ctx context.Context, exec boil.ContextExecutor, related *DTBMember) error {
	var err error
	...
	for i, ri := range related.R.CreatorDTBClassCategories {
		if queries.Equal(o.CreatorID, ri.CreatorID) {
			continue
		}

		ln := len(related.R.CreatorDTBClassCategories)
		if ln > 1 && i < ln-1 {
			related.R.CreatorDTBClassCategories[i] = related.R.CreatorDTBClassCategories[ln-1]
		}
		related.R.CreatorDTBClassCategories = related.R.CreatorDTBClassCategories[:ln-1]
		break
	}
	return nil
}
...
// AddClassCategoryID1DTBProductClasses adds the given related objects to the existing relationships
// of the dtb_class_category, optionally inserting them as new records.
// Appends related to o.R.ClassCategoryID1DTBProductClasses.
// Sets related.R.ClassCategoryID1 appropriately.
func (o *DTBClassCategory) AddClassCategoryID1DTBProductClasses(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*DTBProductClass) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.ClassCategoryID1, o.ID)
	...
	if o.R == nil {
		o.R = &dtbClassCategoryR{
			ClassCategoryID1DTBProductClasses: related,
		}
	} else {
		o.R.ClassCategoryID1DTBProductClasses = append(o.R.ClassCategoryID1DTBProductClasses, related...)
	}
	...
	for _, rel := range related {
		if rel.R == nil {
			...
			rel.R.ClassCategoryID1 = o
		}
	}
	return nil
}

// SetClassCategoryID1DTBProductClasses removes all previously related items of the
// dtb_class_category replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.ClassCategoryID1's ClassCategoryID1DTBProductClasses accordingly.
// Replaces o.R.ClassCategoryID1DTBProductClasses with related.
// Sets related.R.ClassCategoryID1's ClassCategoryID1DTBProductClasses accordingly.
func (o *DTBClassCategory) SetClassCategoryID1DTBProductClasses(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*DTBProductClass) error {
	query := "update `dtb_product_class` set `class_category_id1` = null where `class_category_id1` = ?"
	...
	if o.R != nil {
		for _, rel := range o.R.ClassCategoryID1DTBProductClasses {
			queries.SetScanner(&rel.ClassCategoryID1, nil)
			if rel.R == nil {
				continue
			}

			rel.R.ClassCategoryID1 = nil
		}

		o.R.ClassCategoryID1DTBProductClasses = nil
	}
	return o.AddClassCategoryID1DTBProductClasses(ctx, exec, insert, related...)
}

// RemoveClassCategoryID1DTBProductClasses relationships from objects passed in.
// Removes related items from R.ClassCategoryID1DTBProductClasses (uses pointer comparison, removal does not keep order)
// Sets related.R.ClassCategoryID1.
func (o *DTBClassCategory) RemoveClassCategoryID1DTBProductClasses(ctx context.Context, exec boil.ContextExecutor, related ...*DTBProductClass) error {
	var err error
	for _, rel := range related {
		queries.SetScanner(&rel.ClassCategoryID1, nil)
		if rel.R != nil {
		...
		if _, err = rel.Update(ctx, exec, boil.Whitelist("class_category_id1")); err != nil {
			return err
		}
	}
	if o.R == nil {
	...
	for _, rel := range related {
		for i, ri := range o.R.ClassCategoryID1DTBProductClasses {
			if rel != ri {
				continue
			}

			ln := len(o.R.ClassCategoryID1DTBProductClasses)
			if ln > 1 && i < ln-1 {
				o.R.ClassCategoryID1DTBProductClasses[i] = o.R.ClassCategoryID1DTBProductClasses[ln-1]
			}
			o.R.ClassCategoryID1DTBProductClasses = o.R.ClassCategoryID1DTBProductClasses[:ln-1]
			break
		}
	}
...
// AddClassCategoryID2DTBProductClasses adds the given related objects to the existing relationships
// of the dtb_class_category, optionally inserting them as new records.
// Appends related to o.R.ClassCategoryID2DTBProductClasses.
// Sets related.R.ClassCategoryID2 appropriately.
func (o *DTBClassCategory) AddClassCategoryID2DTBProductClasses(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*DTBProductClass) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.ClassCategoryID2, o.ID)
			if err = rel.Insert(ctx, exec, boil.Infer()); err != nil {
				return errors.Wrap(err, "failed to insert into foreign table")
			}
		} else {
	...
	if o.R == nil {
		o.R = &dtbClassCategoryR{
			ClassCategoryID2DTBProductClasses: related,
		}
	} else {
		o.R.ClassCategoryID2DTBProductClasses = append(o.R.ClassCategoryID2DTBProductClasses, related...)
	}
	...
	for _, rel := range related {
		if rel.R == nil {
			...
			rel.R.ClassCategoryID2 = o
		}
	}
	return nil
}

// SetClassCategoryID2DTBProductClasses removes all previously related items of the
// dtb_class_category replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.ClassCategoryID2's ClassCategoryID2DTBProductClasses accordingly.
// Replaces o.R.ClassCategoryID2DTBProductClasses with related.
// Sets related.R.ClassCategoryID2's ClassCategoryID2DTBProductClasses accordingly.
func (o *DTBClassCategory) SetClassCategoryID2DTBProductClasses(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*DTBProductClass) error {
	query := "update `dtb_product_class` set `class_category_id2` = null where `class_category_id2` = ?"
	values := []interface{}{o.ID}
	if boil.DebugMode {
		fmt.Fprintln(boil.DebugWriter, query)
		fmt.Fprintln(boil.DebugWriter, values)
	...
	if o.R != nil {
		for _, rel := range o.R.ClassCategoryID2DTBProductClasses {
			queries.SetScanner(&rel.ClassCategoryID2, nil)
			if rel.R == nil {
				continue
			}

			rel.R.ClassCategoryID2 = nil
		}

		o.R.ClassCategoryID2DTBProductClasses = nil
	}
	return o.AddClassCategoryID2DTBProductClasses(ctx, exec, insert, related...)
}

// RemoveClassCategoryID2DTBProductClasses relationships from objects passed in.
// Removes related items from R.ClassCategoryID2DTBProductClasses (uses pointer comparison, removal does not keep order)
// Sets related.R.ClassCategoryID2.
func (o *DTBClassCategory) RemoveClassCategoryID2DTBProductClasses(ctx context.Context, exec boil.ContextExecutor, related ...*DTBProductClass) error {
	var err error
	for _, rel := range related {
		queries.SetScanner(&rel.ClassCategoryID2, nil)
		if rel.R != nil {
		...
		if _, err = rel.Update(ctx, exec, boil.Whitelist("class_category_id2")); err != nil {
			return err
		}
	}
	if o.R == nil {
	...
	for _, rel := range related {
		for i, ri := range o.R.ClassCategoryID2DTBProductClasses {
			if rel != ri {
				continue
			}

			ln := len(o.R.ClassCategoryID2DTBProductClasses)
			if ln > 1 && i < ln-1 {
				o.R.ClassCategoryID2DTBProductClasses[i] = o.R.ClassCategoryID2DTBProductClasses[ln-1]
			}
			o.R.ClassCategoryID2DTBProductClasses = o.R.ClassCategoryID2DTBProductClasses[:ln-1]
			break
		}
	}
